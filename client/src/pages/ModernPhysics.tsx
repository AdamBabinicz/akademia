...
import { Atom, Clock, Bookmark } from 'lucide-react';
...
export default function ModernPhysics({ language }: ModernPhysicsProps) {
  return (
    <div className="min-h-screen transition-all duration-300 ease-in-out" data-testid="modern-physics-page">
      {/* Header */}
      <motion.header 
          ...
          <div className="flex items-center justify-between">
            <div className="ml-16 lg:ml-0">
              ...
              <p className="text-muted-foreground mt-2">
                Odkryj kwantowy świat i teorię względności
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8 space-y-12">
        ...
        >
          <Atom className="w-24 h-24 text-primary mx-auto mb-6" />
          <h2 className="text-2xl font-bold text-foreground mb-4">
            Ta sekcja jest w przygotowaniu
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Wkrótce znajdziesz tutaj fascynujące treści o mechanice kwantowej, 
            teorii względności, efekcie fotoelektrycznym i strukturze atomu. 
