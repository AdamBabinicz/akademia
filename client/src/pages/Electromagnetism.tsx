...
import { Radio, Clock, Bookmark } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-8 space-y-12">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Wkrótce znajdziesz tutaj fascynujące treści o równaniach Maxwella, 
            falach elektromagnetycznych, indukcji i teorii pola. 
