      ...
      const animate = () => {
        setPlanets((prev) =>
          prev.map((planet) => ({
            ...planet,
            angle:
              (planet.angle + planet.speed * speed[0] * 0.02) % (2 * Math.PI),
          }))
        );
      ...
      <CardHeader>
        <div className="flex items-center gap-3">
          ...
          <CardTitle className="text-2xl">
            <FormattedMessage
              id="planetaryMotion.title"
              defaultMessage="Ruch planet wokół Słońca"
            />
          </CardTitle>
        </div>
      </CardHeader>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium">
              <FormattedMessage
                id="planetaryMotion.speed"
                defaultMessage="Prędkość animacji"
              />
            </label>
            <span className="text-primary font-mono text-sm">{speed[0]}x</span>
          </div>
