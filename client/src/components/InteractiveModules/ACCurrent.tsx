    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-2xl font-bold text-card-foreground">
          <FormattedMessage
            id="acCurrent.title"
            defaultMessage="Wizualizacja prądu zmiennego"
          />
        </h3>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div>
          <p className="text-muted-foreground mb-6">
            <FormattedMessage
              id="acCurrent.description"
              defaultMessage="Zmień częstotliwość prądu zmiennego i obserwuj, jak drgają elektrony. Zauważ, że energia jest przenoszona przez falę, nie przez ruch elektronów!"
            />
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              ...
              >
                <FormattedMessage
                  id="acCurrent.preset.eu"
                  defaultMessage="50 Hz (UE)"
                />
              </Button>
              <Button
                variant="outline"
              ...
              >
                <FormattedMessage
                  id="acCurrent.preset.us"
                  defaultMessage="60 Hz (USA)"
                />
              </Button>
              <Button
                variant="outline"
              ...
              >
                1 Hz (
                <FormattedMessage id="acCurrent.slow" defaultMessage="wolno" />)
              </Button>
            </div>
          </div>
        </div>
        ...
        <div
          className="bg-muted rounded-lg p-6 relative"
          style={{ height: "300px" }}
        >
          <h4 className="text-sm font-medium text-muted-foreground mb-4">
            <FormattedMessage
              id="acCurrent.oscillations"
              defaultMessage="Drgania elektronów"
            />
          </h4>
            ...
            >
              ...
              <path
                d={`M 0 100 ${Array.from({ length: 20 }, (_, i) => {
                  ...
                  const y =
                    100 +
                    Math.sin(((oscillationPhase + i * 18) * Math.PI) / 180) *
                      30;
                  return `L ${x} ${y}`;
                }).join(" ")}`}
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-muted-foreground">
              <FormattedMessage
                id="acCurrent.wave"
                defaultMessage="Fala elektromagnetyczna niosąca energię →"
              />
            </p>
          </div>
        </div>
